...
const DEMO_PRESENTATION: Presentation = {
  ...
  slides: [
    ...
    },
    {
      ...
      stats: [
        { value: "$7-10M", label: "Availability", description: "Tier 1 sponsorship" },
        { value: "50M+", label: "Global Viewers", description: "Per event" },
        { value: "85%", label: "Engagement Rate", description: "Social mentions" },
        { value: "#1", label: "Trending", description: "On event night" },
      ],
    ...
    },
    {
      ...
      features: [
        { title: "Title Sponsor", description: "Full ring branding, broadcast integration, and exclusive content series. Brought to you by messaging." },
        { title: "Ring Canvas", description: "Prime floor positioning visible in every camera angle. Maximum brand exposure during all bouts." },
        { title: "Digital Integration", description: "Smart TV overlays, social media activations, and Netflix platform branded content." },
        { title: "Commercial Breaks", description: "Premium ad slots during broadcast breaks with guaranteed minimum viewership." },
        { title: "Venue Branding", description: "Physical presence at the venue with signage, activation areas, and VIP hospitality." },
        { title: "Content Series", description: "Behind-the-scenes branded content series leading up to the main event." },
      ],
      backgroundVariant: "dark",
    },
    {
    ...
    },
    {
      ...
      stats: [
        { value: "340%", label: "ROI", description: "Average sponsor return" },
        { value: "12.5M", label: "Social Impressions", description: "Per event average" },
        { value: "4.2M", label: "New Subscribers", description: "Event-driven signups" },
      ],
      backgroundVariant: "dark",
    },
    {
